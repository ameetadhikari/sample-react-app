...
let myaccount = algosdk.mnemonicToSecretKey("bus hockey spell casual sort fantasy section misery bracket heart rate shadow model music unfair horn drama invest happy put tent write oyster absent cruise");
